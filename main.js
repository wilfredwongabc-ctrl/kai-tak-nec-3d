...
import {views,S} from "./data.js?v=16";
import {build} from "./model.js?v=16";
...
r.setPixelRatio(Math.min(devicePixelRatio,2));r.setSize(innerWidth,innerHeight);r.shadowMap.enabled=true;host.appendChild(r.domElement);
...
const names={overview:"整體鳥瞰",entrance:"影片入口",publicDouble:"公共走廊雙門",equipment:"設備牆",partA:"Part Plan A",drain:"沉板／去水",accessible:"無障礙洗手間",publicCorridor:"公共走廊門",link:"升降機接駁",partB:"Part Plan B",elevatorEntrance:"升降機出入口",tailPortal:"尾段入口",tail:"較暗尾段"};
